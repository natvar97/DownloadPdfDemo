...
import com.indialone.downloadpdfdemo.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    private val fileUrl = "http://team.nirmalrecharge.com/external/tempTickets/Ticket-32.pdf"
    ...
    private fun setDownloadButtonClickListener() {
        ...
        val fileName = "Ticket-32.pdf"
        val file = File(folder, fileName)
        val uri = context?.let {
            FileProvider.getUriForFile(it, "com.indialone.downloadpdfdemo.provider", file)
        }
